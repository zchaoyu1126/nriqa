...
sharp_img = imread('F:\thesis\code\MaxPool\data\sharp_image.jpg');
blurry_img = imread('F:\thesis\code\MaxPool\data\blurry_image.jpg');
...
load('F:\thesis\code\MaxPool\utilities\HVS_MaxPol_kernel.mat');
...
h = figure();%('rend','painters','pos', [200 , 50, 1000, 600]);
% HVS-MaxPol
subplot(2,1,1)
imshow(sharp_img)
...
r = get(gcf, 'renderer'); print(gcf, '-dpng', '-r150', ['-' r], 'F:\thesis\code\MaxPool\results\fig_HVS_MaxPol.png'); close;