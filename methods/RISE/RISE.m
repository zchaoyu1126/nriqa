...
system('..\code\methods\RISE\svm-scale  -r ..\code\methods\RISE\range test_ind.txt >> test_ind_scaled');          %归一化
system('..\code\methods\RISE\svm-predict  -b 1  test_ind_scaled ..\code\methods\RISE\model output.txt>dump');     %预测分数
load output.txt;
